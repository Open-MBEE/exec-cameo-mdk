...
public class UtilsGetStereotypeTeamworkTest {

    private static String projectId = "ID_10_15_15_1_41_52_PM_5b84f7be_1506a83819c__6bce_cae_tw_jpl_nasa_gov_128_149_19_85";
    private static String credentials = "../resources/test/mms.properties";
    private static File credentialsFile;


    public UtilsGetStereotypeTeamworkTest() {
    }
    ...
    public static void setupProject() throws IOException, ServerException, URISyntaxException {
        ...
        MDKTestHelper.teamworkLoadProject(projectId, null, credentialsFile, "");
    }
