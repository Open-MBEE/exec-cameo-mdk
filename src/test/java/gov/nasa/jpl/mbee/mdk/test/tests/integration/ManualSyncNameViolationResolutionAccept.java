...
// *
// */
//public class ManualSyncNameViolationResolutionAccept extends MDKTestHelper
//{
//    //global test vars
//    static String testName = "ManualSyncNameViolationResolutionAccept";
...
//        Result results = jCore.run(ManualSyncNameViolationResolutionAccept.class);
//        printJunitResults(results);
//        System.exit(0);
//    }
//
//    public ManualSyncNameViolationResolutionAccept (String testMethodToRun, String testName)
//    {
...
//
//        suite.addTest(new ManualSyncNameViolationResolutionAccept("executeTest", "execute test"));
//
//        return suite;
//    }
//
...
//        //resolve violation
//        try {
//            if (!MDKHelper.getManualValidationWindow().acceptSpecificTypeMDChangesToMMS("[NAME]", violationTargets).isEmpty()) {
//                fail("Element not found in validation results");
//            } else {
