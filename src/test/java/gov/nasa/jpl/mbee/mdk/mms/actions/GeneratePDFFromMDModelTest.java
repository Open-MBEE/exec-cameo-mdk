...
public class GeneratePDFFromMDModelTest 
{
    ...
    public static void setupProject() throws Exception  {
        ...
        //File docGenProjectFile = new File(userdir + File.separator + "samples" + File.separator + "MDK" + File.separator + "mms3.4_plot_test.mdzip");
    ...
    public void testMDKModeltoPDFDocGenUsersGuide() {
    	...
    	try {
    		...
    		//BaseElement documentElement = project.getElementByID("_19_0_52c017d_1541440659051_356599_21285"); //mms-test
