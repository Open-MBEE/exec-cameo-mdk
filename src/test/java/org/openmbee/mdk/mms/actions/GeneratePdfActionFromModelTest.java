...
public class GeneratePdfActionFromModelTest {
    ...
    public static void setupProject() throws Exception {
        ...
        docbookXslFo = new File(userdir + File.separator + "plugins" + File.separator + "org.openmbee.mdk" + File.separator + "docbook-xsl" + File.separator + "fo" + File.separator + "mdk-default.xsl");
