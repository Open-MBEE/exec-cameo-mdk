...
from com.nomagic.uml2.ext.magicdraw.compositestructures.mdinternalstructures  import Connector
...
noApply = {}
from SystemsReasoner import SRUtils as SR
reload(SR)
					...
					if len(bLocalSter)>0:
						for bL in bLocalSter:
							...
							if len(localSterApply)==1:
								...
								bLgeneralizations = SR.getGeneralizationTree(bL)
