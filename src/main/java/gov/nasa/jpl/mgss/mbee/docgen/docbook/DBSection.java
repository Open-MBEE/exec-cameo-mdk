...
/**
 * A Section or Appendix. If you want to make a new section, instance this and add content to it. You can also set it to skip or output a string if the content ends up being empty.<br/>
 * You don't have to set the chapter flags, those will be done automatically based on document structure once the whole document is assembled.<br/>
 * 
