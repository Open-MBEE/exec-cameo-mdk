...
public class DocGenEmbeddedWebServer {
	 ...
	 *  tomcat-7.0/
	 *    servlet-api.jar (2.5 or later, using 3.0)
	 *      - Servlet jar
	 * 	  jsp-api.jar
	 *      - for JSP support when using spring
     *  slf4j-api-1.7.2.jar/slf4j-log4j12-1.7.2
     *    - SLF4j required for logging with Spring 3.0 - needs LocationAwareLogger
     *  
     *  TODO: There are issues with the existing MD classpath that is used for the IMCE-CI build that need to
     *        be resolved. In otherwords the JARs listed below need to be removed from the classpath.
     *
     *  MD_HOME/
     *    lib/
     *      jboss*
     *        Interferes with the servlet APIs
     *      slf4j*
     *    plugins/
