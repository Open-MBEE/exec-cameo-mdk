...
public class CommentsViewWindow extends JFrame {
	...
	public void addComment(Comment c, Stereotype s) {
		addComment(c.getBody(),
				CommentUtil.timestamp(c, s),
				CommentUtil.author(c, s));
	}
	...
	/**
	 * This is useful for testing the look and feel of the comments view
	 * without starting up MagicDraw.
	 * 
	 * @param args
	 */
