 ...
 * assign a name to a column number (this is needed if you have table entries that span columns)<br/>
 * if just given a column number to constructor the col name would be the string of the integer
 * a list of colspecs can be assigned to a DBTable<br/>
 * @author dlam
 *
 */
