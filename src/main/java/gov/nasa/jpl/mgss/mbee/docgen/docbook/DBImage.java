...
/**
 * Print an image with optional caption. If you're using this directly, you will need to add the documentation as the caption if applicable, and set the title.
 * @author dlam
 *
 */
