...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Col Spec</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.ColSpecImpl#getColname <em>Colname</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.ColSpecImpl#getColwidth <em>Colwidth</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.ColSpecImpl#getColnum <em>Colnum</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ColSpecImpl extends ViewElementImpl implements ColSpec {
	...
	public void setColname(String newColname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DgviewPackage.COL_SPEC__COLNAME, oldColname, colname));
	}
	...
	public void setColwidth(String newColwidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DgviewPackage.COL_SPEC__COLWIDTH, oldColwidth, colwidth));
	}
	...
	public void setColnum(int newColnum) {
		...
		colnum = newColnum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DgviewPackage.COL_SPEC__COLNUM, oldColnum, colnum));
	}
