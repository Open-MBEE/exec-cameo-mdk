...
import gov.nasa.jpl.mgss.mbee.docgen.generator.ViewStructureValidator;
...
/**
 * checks view to viewpoint composition hierarchy - if the view composition hierarchy violates the viewpoint composition
 * @author dlam
 *
 */
