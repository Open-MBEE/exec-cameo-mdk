 ...
 * <ul>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.TableEntryImpl#getMorerows <em>Morerows</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.TableEntryImpl#getNamest <em>Namest</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.TableEntryImpl#getNameend <em>Nameend</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TableEntryImpl extends HasContentImpl implements TableEntry {
	...
	public void setMorerows(int newMorerows) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DgviewPackage.TABLE_ENTRY__MOREROWS, oldMorerows, morerows));
	}
	...
	public void setNamest(String newNamest) {
		...
		namest = newNamest;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DgviewPackage.TABLE_ENTRY__NAMEST, oldNamest, namest));
	}
	...
	public void setNameend(String newNameend) {
		...
		nameend = newNameend;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DgviewPackage.TABLE_ENTRY__NAMEEND, oldNameend, nameend));
	}
