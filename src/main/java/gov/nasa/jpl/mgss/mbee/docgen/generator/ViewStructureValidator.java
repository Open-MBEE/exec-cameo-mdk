...
/**
 * compliment of the InstanceViewpointAction
 * this checks a view hierarchy model against the viewpoints it conforms to
 * @author dlam
 *
 */
public class ViewStructureValidator {
	...
	private List<Element> getChildrenViewpoints(Element v) {
		return Utils.filterElementsByStereotype(Utils.collectAssociatedElements(v, 1, AggregationKindEnum.COMPOSITE), sysmlViewpoint, true, true);
	}
	...
	public List<Element> getNexts(Element e) {
		return Utils.collectDirectedRelatedElementsByRelationshipStereotypeString(e, DocGen3Profile.nextStereotype, 1, false, 0);
	}
	
	public List<Element> getFirst(Element e) {
		return Utils.collectDirectedRelatedElementsByRelationshipStereotypeString(e, DocGen3Profile.firstStereotype, 1, false, 1);
	}
