...
public class DgviewSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DgviewPackage.COL_SPEC: {
				...
				if (result == null) result = caseViewElement(colSpec);
			...
			case DgviewPackage.HAS_CONTENT: {
				...
				if (result == null) result = caseViewElement(hasContent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DgviewPackage.LIST: {
				...
				if (result == null) result = caseHasContent(list);
			...
			case DgviewPackage.LIST_ITEM: {
				...
				if (result == null) result = caseHasContent(listItem);
				if (result == null) result = caseViewElement(listItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DgviewPackage.PARAGRAPH: {
				...
				if (result == null) result = caseViewElement(paragraph);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DgviewPackage.TABLE_ENTRY: {
				...
				if (result == null) result = caseHasContent(tableEntry);
				if (result == null) result = caseViewElement(tableEntry);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DgviewPackage.TABLE_ROW: {
				...
				if (result == null) result = caseHasContent(tableRow);
				if (result == null) result = caseViewElement(tableRow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DgviewPackage.MD_EDITABLE_TABLE: {
				...
				if (result == null) result = caseTable(mdEditableTable);
				if (result == null) result = caseViewElement(mdEditableTable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Col Spec</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Col Spec</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>MD Editable Table</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>MD Editable Table</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
