 ...
 * <ul>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.TableImpl#getBody <em>Body</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.TableImpl#getCaption <em>Caption</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.TableImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.TableImpl#getHeaders <em>Headers</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.TableImpl#getColspecs <em>Colspecs</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.TableImpl#getCols <em>Cols</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TableImpl extends ViewElementImpl implements Table {
	...
	/**
	 * The cached value of the '{@link #getColspecs() <em>Colspecs</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getColspecs()
	 * @generated
	...
	public void setCaption(String newCaption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DgviewPackage.TABLE__CAPTION, oldCaption, caption));
	}
	...
	public EList<TableRow> getHeaders() {
		if (headers == null) {
			headers = new EObjectContainmentEList<TableRow>(TableRow.class, this, DgviewPackage.TABLE__HEADERS);
		}
		return headers;
	}
	...
	public EList<ColSpec> getColspecs() {
		if (colspecs == null) {
			colspecs = new EObjectContainmentEList<ColSpec>(ColSpec.class, this, DgviewPackage.TABLE__COLSPECS);
		}
		return colspecs;
	}
