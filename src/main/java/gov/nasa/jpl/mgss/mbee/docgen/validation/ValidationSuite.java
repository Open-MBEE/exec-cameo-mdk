...
/**
 * if showSummary is true, will show summary of each rule in the suite, the rulel's severity, and number of counts
 * if showDetail is true, will show detail table of all element violations in the form of rule, element, description of violation (optional)
 * if both are true, detail table will come after summary table
 * the title for the tables are suite name + Summary and suite name + detail
 * if ownSection is true, the 2 tables will be put in its own section, with title suite name results
 * @author dlam
 *
 */
