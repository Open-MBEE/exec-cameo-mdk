 ...
 * <ul>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgvalidation.impl.SuiteImpl#isShowDetail <em>Show Detail</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgvalidation.impl.SuiteImpl#isShowSummary <em>Show Summary</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgvalidation.impl.SuiteImpl#isOwnSection <em>Own Section</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgvalidation.impl.SuiteImpl#getName <em>Name</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgvalidation.impl.SuiteImpl#getRules <em>Rules</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SuiteImpl extends EObjectImpl implements Suite {
	/**
	 * The default value of the '{@link #isShowDetail() <em>Show Detail</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isShowDetail()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isShowDetail() <em>Show Detail</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isShowDetail()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isShowSummary() <em>Show Summary</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isShowSummary()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isShowSummary() <em>Show Summary</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isShowSummary()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isOwnSection() <em>Own Section</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isOwnSection()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isOwnSection() <em>Own Section</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isOwnSection()
	 * @generated
	...
	public void setShowDetail(boolean newShowDetail) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DgvalidationPackage.SUITE__SHOW_DETAIL, oldShowDetail, showDetail));
	}
	...
	public void setShowSummary(boolean newShowSummary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DgvalidationPackage.SUITE__SHOW_SUMMARY, oldShowSummary, showSummary));
	}
	...
	public void setOwnSection(boolean newOwnSection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DgvalidationPackage.SUITE__OWN_SECTION, oldOwnSection, ownSection));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DgvalidationPackage.SUITE__NAME, oldName, name));
	}
