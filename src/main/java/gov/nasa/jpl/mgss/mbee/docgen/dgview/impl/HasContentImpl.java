 ...
 * <ul>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.HasContentImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class HasContentImpl extends ViewElementImpl implements HasContent {
	...
	protected EClass eStaticClass() {
		return DgviewPackage.Literals.HAS_CONTENT;
	}
	...
	public EList<ViewElement> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<ViewElement>(ViewElement.class, this, DgviewPackage.HAS_CONTENT__CHILDREN);
		}
		return children;
	}
