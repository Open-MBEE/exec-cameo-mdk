...
public class DgviewFactoryImpl extends EFactoryImpl implements DgviewFactory {
	...
	public static DgviewFactory init() {
		try {
			DgviewFactory theDgviewFactory = (DgviewFactory)EPackage.Registry.INSTANCE.getEFactory("http://mbee.jpl.nasa.gov/docgen/dgview"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DgviewPackage.COL_SPEC: return createColSpec();
			case DgviewPackage.IMAGE: return createImage();
			case DgviewPackage.LIST: return createList();
			case DgviewPackage.LIST_ITEM: return createListItem();
			case DgviewPackage.PARAGRAPH: return createParagraph();
			case DgviewPackage.TABLE: return createTable();
			case DgviewPackage.TABLE_ENTRY: return createTableEntry();
			case DgviewPackage.TEXT: return createText();
			case DgviewPackage.TABLE_ROW: return createTableRow();
			case DgviewPackage.MD_EDITABLE_TABLE: return createMDEditableTable();
			default:
