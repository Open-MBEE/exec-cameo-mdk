 ...
 * <ul>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.ViewElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.ViewElementImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.ViewElementImpl#getFromElementId <em>From Element Id</em>}</li>
 *   <li>{@link gov.nasa.jpl.mgss.mbee.docgen.dgview.impl.ViewElementImpl#getFromProperty <em>From Property</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ViewElementImpl extends EObjectImpl implements ViewElement {
	...
	/**
	 * The default value of the '{@link #getFromElementId() <em>From Element Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getFromElementId() <em>From Element Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFromElementId()
	 * @generated
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DgviewPackage.VIEW_ELEMENT__TITLE, oldTitle, title));
	}
	...
	public void setFromElementId(String newFromElementId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DgviewPackage.VIEW_ELEMENT__FROM_ELEMENT_ID, oldFromElementId, fromElementId));
	}
	...
	public void setFromProperty(FromProperty newFromProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DgviewPackage.VIEW_ELEMENT__FROM_PROPERTY, oldFromProperty, fromProperty));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case DgviewPackage.VIEW_ELEMENT__FROM_ELEMENT_ID:
				return FROM_ELEMENT_ID_EDEFAULT == null ? fromElementId != null : !FROM_ELEMENT_ID_EDEFAULT.equals(fromElementId);
			case DgviewPackage.VIEW_ELEMENT__FROM_PROPERTY:
