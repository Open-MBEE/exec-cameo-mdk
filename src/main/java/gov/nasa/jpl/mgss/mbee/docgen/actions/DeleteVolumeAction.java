...
public class DeleteVolumeAction extends MDAction {
	...
	public void actionPerformed(ActionEvent e) {
		...
		List<Element> projects = Utils.collectDirectedRelatedElementsByRelationshipStereotypeString(proj, DocWebProfile.hasVolume , 2 , false, 1);
		boolean root = false;
		
		for (Element p: projects){
		    if (StereotypesHelper.hasStereotype(p, DocWebProfile.project))
		        root = true;
		}
