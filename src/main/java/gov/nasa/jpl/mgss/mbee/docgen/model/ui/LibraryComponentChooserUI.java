...
public class LibraryComponentChooserUI {
	...
	public LibraryComponentChooserUI(Node<String, MissionComponent> node,
		...
		Object[] selectedComps = missionNode.getData().getLibraryComponents()
				.toArray();
		...
		int[] intArray = ArrayUtils.toPrimitive(selectedIndices
				.toArray(new Integer[selectedIndices.size()]));
	...
	static {
		...
		save.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent paramActionEvent) {
				...
				Set<LibraryComponent> comps = missionNode.getData()
