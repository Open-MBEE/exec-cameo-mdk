...
/**
 * numbers view dependencies (first, next) to the section number their target has
 * @author dlam
 *
 */
public class ViewDependencyNumberer {
	/**
	 * Clear out any existing dependency numbering names on the first, next, nosection relations.
	 * Recursively goes through each view to remove relation names. 
	 * 
	...
	/**
	 * Applies the numbering to the relationships so the outline numbering can be seen.
	 * Recursively goes through each view to add dependency numbers.
	 * 
	 * @param view		View to add dependency numbering strings for
	 * @param prefix	List of the tree hierarchy that includes the numbering prefixes
	 */
