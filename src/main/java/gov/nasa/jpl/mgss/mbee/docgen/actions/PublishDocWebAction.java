...
/**
 * this is just a convenience action for people to publish docgen documents to docweb from magicdraw
 * this does not actually generate the document locally, but tells docweb to add a generation request
 * if document is not already on docweb, docweb will add it to uncategorized under user chosen project
 * @author dlam
 *
 */
	...
	public void actionPerformed(ActionEvent ac) {
		...
		if (url != null && !url.equals("")) {
			...
			try {
				...
				chosenServer = Utils.getUserDropdownSelectionForString("Choose the server to update", "Choose the teamwork server this document is from", names, display);
