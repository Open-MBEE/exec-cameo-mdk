...
public class Saver extends MDAction {
	...
	/**
	 * Saves the style of elements on the active diagram by storing
	 * relevant style information in a JSON-formatted string to a property named "style"
	 * in each respective element.
	 * 
	 * @param e The ActionEvent that fired this method.
	 */
	@Override
	@SuppressWarnings("unchecked") // for JSObject put() method
	public void actionPerformed(ActionEvent e) {
    	...
    	// get JSON style string from each element and store them into a main store for this diagram
	 ...
	 * 
	 * @param style A JSON-formatted style string to load into the created block's property.
	...
	private static void makeBlock(String style, Project proj, DiagramPresentationElement diag) {
		...
		// add the property to the class, then add the class to the diagram's parent
	    try {
	...
	/**
	 * Get a JSON-formatted string representing the style properties of the parameterized
