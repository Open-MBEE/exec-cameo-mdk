...
/**
 * This class contains a run method for the pattern load operation.
...
public class RunnablePatternLoaderWithProgress implements RunnableWithProgress {
	 ...
	 * @param targetElements	the list of elements on the target diagram to load styles into.
	 */
	public RunnablePatternLoaderWithProgress(Project proj, DiagramPresentationElement patternDiagram, List<PresentationElement> targetElements) {
		this.proj = proj;
