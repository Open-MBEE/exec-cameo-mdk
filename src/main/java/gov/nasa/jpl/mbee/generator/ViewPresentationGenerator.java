...
public class ViewPresentationGenerator implements RunnableWithProgress {
    ...
    private ValidationRule uneditable = new ValidationRule("Uneditable", "uneditable", ViolationSeverity.ERROR);
    ...
    public void run(ProgressStatus ps) {
        suite.addValidationRule(uneditable);
    ...
    private Package getFolder(Element view) {
        ...
        Package viewInst = createViewInstancesPackage(); // this is the trunk
                                                         // (find/build package)

        // if you can find the folder with this Utils, just go ahead and return
        // it
        ...
        Package viewTarget = createViewTargetPackage(view); // this is the leaf
                                                            // (find/build
                                                            // package)
        setPackageHierarchy(view, viewInst, viewTarget); // this decides how to
                                                         // join them together
