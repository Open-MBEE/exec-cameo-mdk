...
public class GenerateLocalDocPdf extends MDAction {

    private static final long serialVersionUID = 1L;
    private Element view;
    public static final String DEFAULT_ID = GenerateLocalDocPdf.class.getSimpleName();

    public GenerateLocalDocPdf(Element view) {
        super(DEFAULT_ID, "PDF", null, null);
        this.view = view;
    }
    ...
    private File fileSelect() {
        ...
        choose.setDialogTitle("Save to output PDF...");
    ...
    public void generate(File savefile) {
        ...
        if (userName.length() < 4 || !userName.endsWith(".pdf")) {
            filename = userName + ".pdf";
        }
        File dir = savefile.getParentFile();
        File realfile = new File(dir, filename);
        ProgressStatusRunner.runWithProgressStatus(new DocumentWriter(dge, realfile, genNewImage, dir), "Generating DocGen PDF Document...", true, 0);
    }
