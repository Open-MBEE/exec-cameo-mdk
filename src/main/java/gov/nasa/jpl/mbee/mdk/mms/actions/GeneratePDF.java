...
public class GeneratePDF extends MDAction {
    ...
    protected boolean checkForStyleSheetXMLFile() {
    	...
    	Application.getInstance().getGUILog().showMessage("after selected: " + xslDefaultFile.getAbsolutePath());
    	Application.getInstance().getGUILog().showMessage("exist: " +xslDefaultFile.exists());
    	Application.getInstance().getGUILog().showMessage("not exist: " + !xslDefaultFile.exists());
