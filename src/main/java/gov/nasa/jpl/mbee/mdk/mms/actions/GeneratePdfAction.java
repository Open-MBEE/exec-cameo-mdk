...
import gov.nasa.jpl.mbee.mdk.generator.PdfWriter;
...
public class GeneratePdfAction extends MDAction {
    ...
    protected void generate(File autoGeneratedDocbookfile, File docbookXslFo, File outputPdfFile) {
        ...
        if (doc != null) {
            ProgressStatusRunner.runWithProgressStatus(new PdfWriter(doc, doc.getGenNewImage(), autoGeneratedDocbookfile, docbookXslFo, outputPdfFile), "DocGen", true, 0);
        }
