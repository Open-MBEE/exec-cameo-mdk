...
public class MMSEndpointBuilderConstants {
    // core parameters
    ...
    // uri builder related
    public static final String URI_PROJECT_SUFFIX = "uriProjectSuffix";
    public static final String URI_REF_SUFFIX = "uriRefSuffix";
    public static final String URI_COMMIT_SUFFIX = "uriCommitSuffix";
