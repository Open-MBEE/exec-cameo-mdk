...
public abstract class MDPlugin extends Plugin {
    // TODO? implements ProjectEventListener { // see MDKPlugin and
     ...
     *                     {@link Configurator.Context} exactly.
    ...
    public void init() {
        ...
        // TODO -- Subscribe as a ProjectEventListener; see MDKPlugin and
        // ApplicationSyncEventSubscriber
    ...
    // REVIEW -- Consider providing services from MDKPlugin's
    // ApplicationSyncEventSubscriber.
