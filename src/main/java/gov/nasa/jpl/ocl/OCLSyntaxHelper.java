...
// TODO Auto-generated method stub
    ...
    @Override
    public List
        visitUnlimitedNaturalLiteralExp( UnlimitedNaturalLiteralExp exp ) {
      lastVisited = exp;
    ...
    @Override
    public List
        visitUnspecifiedValueExp( UnspecifiedValueExp unspecifiedvalueexp ) {
    ...
    protected ASTVisitor( String text, int position,
                          ConstraintKind constraintType ) {
      super( text, position, constraintType );
      Debug.outln( "constructed ASTVisitor(" + text + ", " + position + ", "
                   + constraintType + ")" );
    }
  ...
  @Override
  protected Choice createChoice( String name, String description,
                                 ChoiceKind kind, Object element ) {
    // TODO Auto-generated method stub
  ...
  @Override
  protected List< Choice > getChoices( OCLExpression< C > expression,
                                       ConstraintKind constraintType ) {
    // TODO Auto-generated method stub
  ...
  @Override
  public List< Choice >
      getSyntaxHelp( ConstraintKind constraintType, String txt ) {
    // TODO Auto-generated method stub
