...
public class Graphviz {
	public static <VertexType, EdgeType extends DirectedEdge<VertexType>> String directedGraph2DotString(DirectedGraph<VertexType, EdgeType> G) {
	...
	public static <VertexType, EdgeType extends UndirectedEdge<VertexType>> String undirectedGraph2DotString(UndirectedGraph<VertexType, EdgeType> G) {
	...
	public static <VertexType, EdgeType extends DirectedEdge<VertexType>> boolean directedGraph2dotPdf(DirectedGraph<VertexType, EdgeType> G, String fileName, String dotPath) {
		return dotString2pdf(directedGraph2DotString(G), fileName, dotPath); 
	}
	
	public static <VertexType, EdgeType extends UndirectedEdge<VertexType>> boolean unddirectedGraph2dotPdf(UndirectedGraph<VertexType, EdgeType> G, String fileName, String dotPath) {
