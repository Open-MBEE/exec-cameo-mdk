...
public class DirectedGraphHashSet<VertexType, EdgeType extends DirectedEdge<VertexType>> extends
        DirectedHyperGraphHashSet<VertexType, EdgeType> implements DirectedGraph<VertexType, EdgeType> {
