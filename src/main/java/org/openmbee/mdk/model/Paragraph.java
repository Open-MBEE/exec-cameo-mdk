...
public class Paragraph extends Query {
    ...
    private Utils.AvailableAttribute attribute = null; // this is redundant with fromProperty
...
//        }
     ...
     * </code>
     * <p>
     * @see Query#visit(boolean, java.lang.String)
     */
    @Override
                ...
                if (gotStereotypeProperties) {
                    ...
                    if (tryOcl && gotText) {
                        ...
                        if (allTargetsAreProperties && tryOcl) {
                            Object v = Utils.getElementAttribute(e, Utils.AvailableAttribute.Value);
