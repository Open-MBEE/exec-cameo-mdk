...
//    @Override For generate BDD only
//    protected Collection<BaseElement> getLocalElements(Project activeProject)
//    {
//        TSGenerateBDDElementCollector elementCollector =
//                new TSGenerateBDDElementCollector(this.contextElements);
//
//        this.computedElementSet = elementCollector.collectElements();
//        return this.computedElementSet;
//    }
   ...
   public void doDataLoad() throws IOException, TSIntegratorException
   {
      ...
      if (elements != null && !elements.isEmpty()) {
          if (this.drawingViewName.equals(IBD_DRAWING_VIEW_NAME)) { // or parametric, or bdd if generating bdd
